        ...
        <div className="min-h-screen bg-gray-100 text-gray-800">
            ...
            <main className="max-w-4xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
                <section className="mb-8">
                    ...
                    <p>
                        If you’re new, don’t worry — we’ve got you covered! Explore our guides,
                        FAQs, and reach out to support whenever you need assistance. We’re here to
                        help you succeed.
                    </p>
                    <Link
                        href="/help"
                ...
                <section>
                    ...
                    <p>
                        ...
                        track of your progress and don’t forget to have fun while studying!
                    </p>
                </section>
            </main>
